...
`};
export const SVG_Close = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		viewBox="-1 -1 10 10">
...
`};
export const SVG_Confirm = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		width="16"
		height="16"
...
`};
export const SVG_Cancel = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		width="16"
		height="16"
...
`};
export const SVG_Trash = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		width="16"
		height="16"
...
`};
export const SVG_Rename = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		width="16"
		height="16"
...
`};
export const SVG_ArrowUp = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="0 0 330 330"
...
`};
export const SVG_ArrowDown = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG_ArrowUp}
		...${props}
		style=${{ 'transform':'rotate(180deg)' }}/>
`};
export const SVG_Settings = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="-1 -5 8 7">
...
`};
export const SVG_MobileSidebar = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
...
`};
export const SVG_ShowKey = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		width="16"
...
`};
export const SVG_HideKey = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		width="16"
...
`};
export const SVG_SysPrompt = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="0 -10 10 10">
...
`};
export const SVG_instTemplate = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="0 -10 5 10">
...
`};
export const SVG_ChatMode = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="0 0 10 10">
...
`};
export const SVG_CompletionMode = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="2 -1 34 28">
...
`};
export const SVG_Regen = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
...
`};
export const SVG_Undo = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="0 0 24 24"
...
`};
export const SVG_Redo = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG_Undo}
		...${props}
		style=${{ 'transform':'scaleX(-1)' }}/>
`};
export const SVG_Star = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		width="14"
...
`};
export const SVG_StarOutline = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		width="14"
...
`};
export const SVG_Moveable = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG}
		...${props}
		viewBox="0 0 11 11">
...
`};
export const SVG_Stop = ({ ...props }: SVGProps<SVGSVGElement>) => {
		return html`
	<${SVG}
		...${props}
		viewBox="0 0 24 24">
...
`};
export const SVG_Camera = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return html`
    <${SVG}
      ...${props}
      viewBox="0 0 16 16"
...
export const SVG_CheckOn = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
...
`};
export const SVG_CheckOff = ({...props}: SVGProps<SVGSVGElement>) => {
	return html`
	<${SVG} width="1em" height="1em" viewBox="0 0 24 24" ...${props}>
...
export const SVG_SplitView = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return html`
    <${SVG}
      ...${props}
      viewBox="0 0 16 16"
